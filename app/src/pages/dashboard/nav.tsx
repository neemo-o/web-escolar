    ...
    case "TEACHER":
      return [
        ...
        },
        {
          label: "Minhas Turmas",
          items: [
            { id: "my-classrooms", label: "Turmas", icon: iconBook() },
            { id: "my-students", label: "Alunos", icon: iconUsers() },
            { id: "schedule", label: "Calendário", icon: iconCalendar() },
          ],
        },
        {
          label: "Avaliações",
          items: [
            ...
            { id: "grades", label: "Lançar Notas", icon: iconStar() },
    ...
    case "STUDENT":
      return [
        ...
        },
        {
          ...
          items: [
            { id: "my-progress", label: "Meu Progresso", icon: iconChart() },
            { id: "schedule", label: "Calendário", icon: iconCalendar() },
          ],
        },
      ];
